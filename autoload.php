...
class Psr4AutoloaderClass {
	...
	protected function load_mapped_file( $prefix, $relative_class ) {
		...
		foreach ( $this->prefixes[ $prefix ] as $base_dir ) {
			...
			$file = $base_dir
				  . str_replace( '\\', '/', $relative_class ) // test change.
				  . '.php';
...
$block_catalog_loader = new \BlockCatalog\Psr4AutoloaderClass();

// register the autoloader
$block_catalog_loader->register();

// register the base directories for the namespace prefix
$block_catalog_loader->add_namespace( 'BlockCatalog', __DIR__ . '/includes/classes' );
